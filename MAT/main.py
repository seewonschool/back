...
def mat_today_notices():
  notices = crawling_notices("https://math.sogang.ac.kr/front/cmsboardlist.do?siteId=math&bbsConfigFK=1947", "/html/body/div/div[4]/div[2]/div[3]/div/div/ul", "li", "/div/div[2]/a", "/div/div[2]/div/span[2]")
