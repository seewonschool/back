...
def eng_today_notices():
  notices = crawling_notices("https://english.sogang.ac.kr/front/cmsboardlist.do?siteId=english&bbsConfigFK=883", "/html/body/div/div[4]/div[2]/div[3]/div/div/ul", "li", "/div/div[2]/a", "/div/div[2]/div/span[2]")
