...
def aie_today_notices():
  notices = crawling_notices("https://ai.sogang.ac.kr/front/cmsboardlist.do?siteId=ai&bbsConfigFK=5110", "/html/body/div/div[4]/div[2]/div[4]/div/div/ul", "li", "/div/div[2]/a", "/div/div[2]/div/span[2]")
...
crawling_main('AIE/data_aie.json', KakaoConversaionId.AIE, aie_today_notices)